...
def init(pathroot, localwork, from_archive, deploy_override=None, app_directory=None, debug_available=False, local_work_enabled=False, automation_mode=False, tracemalloc_tuning_snapshot=False, dump_root=None):
    global TREE_DUMP_TUNING_SNAPSHOT_BEFORE_ZONE, TREE_DUMP_TUNING_SNAPSHOT_AFTER_ZONE, MEM_REPORT_ZONE_SNAPSHOT, IS_ARCHIVE, APP_ROOT, DEBUG_AVAILABLE, AUTOMATION_MODE, TRACEMALLOC_TUNING_SNAPSHOT, DATA_ROOT, TUNING_ROOTS, SCRIPT_ROOT, _CORE, DLL_PATH, USER_SCRIPT_ROOTS, LAYERS, DUMP_ROOT
