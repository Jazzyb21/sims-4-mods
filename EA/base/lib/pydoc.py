...
def visiblename(name, all=None, obj=None):
    if name in frozenset({'__module__', '__credits__', '__cached__', '__file__', '__package__', '__loader__', '__qualname__', '__name__', '__doc__', '__slots__', '__path__', '__author__', '__version__', '__spec__', '__date__', '__builtins__'}):
        return 0
