...
class ParserBase:
    ...
    def parse_declaration(self, i):
        ...
        while j < n:
            ...
            if c in '"\'':
                ...
                elif decltype in frozenset({'attlist', 'link', 'element', 'linktype'}):
    ...
    def parse_marked_section(self, i, report=1):
        ...
        if j < 0:
            return j
        if sectName in frozenset({'rcdata', 'include', 'temp', 'cdata', 'ignore'}):
            ...
            if c == '<':
                ...
                if rawdata[j:j + 4] == '<!--':
                    ...
                    if j < 0:
                        ...
                        if j == -1:
                            return -1
                        if name not in frozenset({'attlist', 'element', 'notation', 'entity'}):
