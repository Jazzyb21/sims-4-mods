        ...
        for target in targets:
            ...
            if parent_objects is None:
                if self.negate:
                    ...
                    if self.check_part_owner and parent is not None and self.require_parent_is_surface and parent.is_surface(include_parts=self.check_part_owner):
                ...
                if not test_parent.is_surface(include_parts=self.check_part_owner):
                    test_parent = None
                if test_parent is not None and self.check_part_owner and test_parent is not None and self.require_parent_is_surface and self.negate:
