...
class NPCInviteSituationDramaNode(BaseDramaNode):
    ...
    def _test(self, resolver, skip_run_tests=False):
        ...
        if skip_run_tests or self.run_over_user_facing_situations or services.get_zone_situation_manager().is_user_facing_situation_running(global_user_facing_only=True):
