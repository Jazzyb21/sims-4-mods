    ...
    def _get_privacy_status(self, sim):
        ...
        if participant_type == ParticipantType.Actor and privacy_interaction.privacy:
            ...
            if not privacy_interaction.get_liability(PRIVACY_LIABILITY):
                ...
                if len(remaining_transitions) == 1 or not (body_posture.mobile and next_body_posture.mobile and is_transition_between_parts(body_posture, sim.posture_state.body_target, next_body_posture, remaining_transitions[0].body_target)):
