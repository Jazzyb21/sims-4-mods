...
class SimKnowledge:
    __slots__ = ('_rel_data', '_known_traits', '_knows_career', '_known_stats', '_knows_major', '_knows_romantic_preference', '_knows_woohoo_preference', '_known_romantic_genders', '_known_woohoo_genders', '_known_exploring_sexuality')
