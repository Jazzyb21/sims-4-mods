...
class BowlingVenueMixin:
    ...
    MOONLIGHT_AFFORDANCES = TunableTuple(description='\n        Super affordances to set moonlight bowling lane when they are turned\n        on and turned off.\n        ', moonlight_on=TunableReference(description='\n            A super affordance when the moonlight is turned on.\n            ', manager=services.get_instance_manager(sims4.resources.Types.INTERACTION), class_restrictions=('SwitchLightAndStateImmediateInteraction',), pack_safe=True), moonlight_off=TunableReference(description='\n            A super affordance when the moonlight is turned off.\n            ', manager=services.get_instance_manager(sims4.resources.Types.INTERACTION), class_restrictions=('SwitchLightAndStateImmediateInteraction',), pack_safe=True))
