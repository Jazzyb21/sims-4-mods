...
lock_instance_tunables(SimBackgroundSituation, should_send_on_lot_home_in_super_speed_3=True, creation_ui_option=SituationCreationUIOption.NOT_AVAILABLE, _implies_greeted_status=False)