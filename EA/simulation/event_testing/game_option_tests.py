...
class TestableGameOptions(enum.IntFlags):
    ...
    REQUIRED_PACK_BY_OPTION = frozendict({NPC_RELATIONSHIP_AUTONOMY_ENABLED: Pack.EP12, RESTRICT_NPC_WEREWOLVES: Pack.GP12, DUST_SYSTEM_ENABLED: Pack.SP22, ECO_FOOTPRINT_GAMEPLAY: Pack.EP09, CIVIC_POLICY_NPC_VOTING_ENABLED: Pack.EP09})
