...
class UiDialogResponse(HasTunableSingletonFactory, AutoFactoryInit):
    ...
    def __init__(self, sort_order=0, dialog_response_id=ButtonType.DIALOG_RESPONSE_NO_RESPONSE, text=None, subtext=None, ui_request=UiDialogUiRequest.NO_REQUEST, response_command=None, disabled_text=None, audio_event_name=None):
        ...
        super().__init__(sort_order=sort_order, dialog_response_id=dialog_response_id, ui_request=ui_request, response_command=response_command, audio_event_name=audio_event_name)
...
class UiDialogOk(UiDialog):
    ...
    @property
    def responses(self):
        return (UiDialogResponse(dialog_response_id=ButtonType.DIALOG_RESPONSE_OK, text=self.text_ok, ui_request=UiDialogResponse.UiDialogUiRequest.NO_REQUEST, audio_event_name=self.audio_ok),)
