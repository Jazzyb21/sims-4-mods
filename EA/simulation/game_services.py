...
def start_services(save_slot_data):
    ...
    if service_manager is None:
        ...
        service_list = [GlobalFlagService(), ZoneReservationService(), LifestyleService(), BusinessService(), CallToActionService(), GameClock(), TimeService(), ConfigService(), CheatService(), EventManagerService(), ClientManager(manager_id=MGR_CLIENT), UtilitiesManager(), HouseholdManager(manager_id=MGR_HOUSEHOLD), RelationshipService(), RelgraphService.get_relgraph_service(), AgingService(), SimInfoManager(manager_id=MGR_SIM_INFO), CurfewService(), SicknessService(), HiddenSimService(), HolidayService(), SeasonService(), WeatherService(), NarrativeService(), GlobalPolicyService(), ClubService(), RabbitHoleService(), LotDecorationService(), StyleService(), TutorialService(), TrendService(), ObjectLostAndFoundService(), AnimalService(), LandlordService(), RoommateService(), OrganizationService(), StreetService(), VenueGameService(), RegionService(), CullingService(), LiveEventService(), PurchasePickerService(), MiscOptionsService(), LunarCycleService(), ClanService(), SocialMediaService(), PromService(), GraduationService(), FashionTrendService()]
