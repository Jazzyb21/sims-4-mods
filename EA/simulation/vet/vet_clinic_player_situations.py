...
lock_instance_tunables(VetClinicDiagnosisSituation, exclusivity=BouncerExclusivityCategory.NORMAL, creation_ui_option=SituationCreationUIOption.NOT_AVAILABLE, duration=0, situation_display_type_override=SituationDisplayType.VET)