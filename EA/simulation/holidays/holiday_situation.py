...
lock_instance_tunables(HolidaySituation, exclusivity=BouncerExclusivityCategory.NEUTRAL, creation_ui_option=SituationCreationUIOption.NOT_AVAILABLE, duration=0, _implies_greeted_status=False, situation_display_type_override=SituationDisplayType.SIM_SPECIFIC)